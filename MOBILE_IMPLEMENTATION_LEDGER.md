...
| `APERTURE_API_BASE_URL` | Base URL the generated client issues requests against | No | `https://<service>-<project-number>.<region>.run.app` | Platform/API | `Info.plist` via `project.pbxproj`; `ApertureEnvironment.swift` | Dev and production API calls | Confirmed | Live dev: `https://lp-core-api-dev-212649801370.us-central1.run.app` |
