...
| Document AI | **Azure AI Document Intelligence** — `prebuilt-idDocument`, `prebuilt-read`, `prebuilt-layout`, custom classifier + custom neural extractors | Prebuilt ID model covers passports worldwide and US green cards, driver licences, SSN cards; custom neural for the rest | [03 §3.10](03-solution-architecture.md#310-ai-service-selection) |
